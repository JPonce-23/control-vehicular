...
async function mostrarPreview() {
    ...
    try {
        ...
        <p><strong>Vehículo:</strong> 
            ${preview.vehiculo?.marca || ""} 
            ${preview.vehiculo?.tipo || ""} 
            ${preview.vehiculo?.modelo_anio || ""}
        </p>
        ...
        <p><strong>Persona:</strong> 
            ...
            ${preview.persona?.apellido_paterno || ""} 
            ${preview.persona?.apellido_materno || ""}
        </p>
...
async function generarResguardo(event) {
    ...
    try {
        console.log("Antes del POST - salidaId:", salidaId);
        
        await apiFetch(`/salidas/${salidaId}/resguardo`, {
            method: "POST"
        });

        console.log("Después del POST - salidaId:", salidaId);
        console.log("Select value actual:", selectSalida.value);
